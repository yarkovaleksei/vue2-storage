# vue2-storage Contributing Guide
...
### Work Step Example
- Fork the repository from [yarkovaleksei/vue2-storage](https://github.com/yarkovaleksei/vue2-storage) !
- Create your topic branch from `dev`: `git branch my-new-topic origin/dev`
- Add codes and pass tests !
- Commit your changes: `git commit -am 'Add some topic'`
- Push to the branch: `git push origin my-new-topic`
- Submit a pull request to `dev` branch of `yarkovaleksei/vue2-storage` repository !
